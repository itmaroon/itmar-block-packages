...
function AnimationBlock(props) {
    ...
    return (jsx(Fragment, { children: jsxs(PanelBody, { title: __("Animation Setting", "block-collections"), initialOpen: true, children: [jsx(ToggleControl, { label: __("Is Animation", "block-collections"), checked: is_anime, onChange: (newVal) => {
                        props.onChange({ is_anime: newVal });
                    } }), is_anime && (jsxs(Fragment, { children: [jsx("div", { className: "itmar_link_type", children: jsx(RadioControl, { label: __("Animation Pattern", "block-collections"), selected: anime_prm.pattern, options: [
                                ...
                                } }) }), jsx(RangeControl, { value: anime_prm.duration, label: __("Animation duration time", "block-collections"), max: 5, min: 0, onChange: (val) => {
                                // val が undefined の場合は 0（または適切なデフォルト値）を採用する
                                const safeValue = val ?? 0;
                                props.onChange({
                                    anime_prm: { ...anime_prm, duration: safeValue },
                                });
                            }, step: 0.1, withInputField: true }), jsx(RangeControl, { value: anime_prm.delay, label: __("Animation delay time", "block-collections"), max: 3, min: 0, onChange: (val) => {
                                // val が undefined の場合は 0（または適切なデフォルト値）を採用する
                                const safeValue = val ?? 0;
                                props.onChange({
                                    anime_prm: { ...anime_prm, delay: safeValue },
                                });
                            }, step: 0.1, withInputField: true }), jsx("div", { className: "itmar_link_type", children: jsx(RadioControl, { label: __("Animation Trigger", "block-collections"), selected: anime_prm.trigger, options: [
                                    {
