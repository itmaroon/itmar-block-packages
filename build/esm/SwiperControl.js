...
function slideBlockSwiperInit(swiperElement) {
  ...
  var effectOption = {
    ...
    slide_single_view: _objectSpread2({
      direction: swiper_info.singleDirection,
      loopAdditionalSlides: 1,
      speed: swiper_info.slideSpeed,
      allowTouchMove: false
    }, parallax_option),
    fade_single_view: _objectSpread2({
      speed: swiper_info.slideSpeed,
      effect: "fade",
      fadeEffect: {
        crossFade: true
  ...
  var swiperOptions = _objectSpread2({
    loop: swiper_info.loop
  }, autoplayOption);
  if (is_thumbnail) {
    swiperOptions = _objectSpread2(_objectSpread2({}, swiperOptions), {}, {
  ...
  if (swiper_info.effect && effectOption[swiper_info.effect]) {
    swiperOptions = _objectSpread2(_objectSpread2({}, swiperOptions), effectOption[swiper_info.effect]);
  }
