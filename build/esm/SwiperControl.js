...
import { Thumbs, Parallax, EffectCards, EffectFlip, EffectCube, EffectCoverflow, EffectFade, Navigation, Pagination, Scrollbar } from 'swiper/modules';
...
function slideBlockSwiperInit(swiperElement) {
    ...
    const el = typeof swiperElement === "string"
    ...
    if (swiper_id)
        swiperRegistry.set(swiper_id, swiperObj);
    // 連携処理
    tryLink(swiperObj);
    return swiperObj;
}

export { slideBlockSwiperInit };
