...
import { resolveTarget } from './styleDataApply.js';
...
const styleComponentApply = (StyleComp, blockSelector, options = {}) => {
    ...
    blocks.forEach((el) => {
        ...
        try {
            ...
            let styleTags = "";
            try {
                html = renderToString(sheet.collectStyles(jsx(StyleComp, { attributes: attributes })));
...
export { resolveTarget, styleComponentApply };
