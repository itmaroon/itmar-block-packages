import { asyncToGenerator as _asyncToGenerator, objectWithoutProperties as _objectWithoutProperties } from './_virtual/_rollupPluginBabelHelpers.js';
...
function _generateCodeChallenge() {
  _generateCodeChallenge = _asyncToGenerator(function* (codeVerifier) {
...
function _redirectCustomerAuthorize() {
  _redirectCustomerAuthorize = _asyncToGenerator(function* (shopId, clientId, userMail, callbackUri, redirectUri) {
    //呼び出し元の戻り先
    var statePayload = {
      ts: Date.now(),
...
function _checkCustomerLoginState() {
  _checkCustomerLoginState = _asyncToGenerator(function* () {
...
function _sendRegistrationRequest() {
  _sendRegistrationRequest = _asyncToGenerator(function* (urlOrPath) {
...
export { checkCustomerLoginState, redirectCustomerAuthorize, sendRegistrationRequest };
